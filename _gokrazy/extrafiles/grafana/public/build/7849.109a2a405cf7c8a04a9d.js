...
`,ve=["children","className"],xe=["children","className","width","style"];function we(e,t){if(null==e)return{};var n,r,s={},a=Object.keys(e);for(r=0;r<a.length;r++)n=a[r],t.indexOf(n)>=0||(s[n]=e[n]);return s}const _e=()=>({flexRow:m`
  ...
  `;return{nameWrapper:m`
    ...
    `,TickLabelsLabel:m`
      ...
      position: absolute;
      user-select: none;
    `});function hr(e){const{numTicks:t,duration:n}=e,r=(0,g.useStyles2)(ur),s=[];for(let e=0;e<t+1;e++){const a=e/t,o=1===a?{right:"0%"}:{left:100*a+"%"};s.push((0,y.jsx)("div",{className:r.TickLabelsLabel,style:o,"data-test":"tick",children:W(n*a)},a))}return(0,y.jsx)("div",{className:r.TickLabels,children:s})}const mr=()=>({GraphTick:m`
      label: GraphTick;
      stroke: #aaa;
      stroke-width: 1px;
